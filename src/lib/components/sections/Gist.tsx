...
const Gist = () => (
  <Box px={[4, 16]} my={["3rem", "5rem"]}>
    <Heading fontSize={["1.5rem", "2.5rem"]} color="brand.200">
      Latest Gist
    </Heading>
    <Stack align="center" direction={["column", "row"]} mt={[5, 10]}>
      <VStack w={{ base: "full", md: "60%", lg: "40%" }} spacing="10">
        <Heading
